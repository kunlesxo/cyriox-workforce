    ...
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <main className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 md:p-12">
        ...
        <button
          ...
          className="flex items-center justify-center w-[390px] px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-full mt-4 shadow-sm hover:bg-gray-100 transition"
        >
